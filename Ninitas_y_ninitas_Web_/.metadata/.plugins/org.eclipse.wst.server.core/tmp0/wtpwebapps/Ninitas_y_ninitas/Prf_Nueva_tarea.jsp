...
<html>
    ...
    <script>
        function a_a(){
    document.p_n_tarea.action="p_a_tarea"; 
    document.p_n_tarea.submit();}
        </script>
    ...
    <body style="background-image: url('img/222.jpg'); background-size: 100%;">
        ...
        <form action="p_n_tarea" method="post">
            <center>
                <h5>
                    <table>
                        <tr><td colspan="2">NUEVA TAREA</td></tr>
                        <tr><td>fecha entrega: </td><td><input type="text" name="txt_F_Entrega"></td></tr>
                        <tr><td>Contenido: </td><td><input type="text" name="txt_Conte"></td></tr>
                        <tr><td><input type="submit" name="txt" value="Registrar tarea"></td></tr>
                        ${v_a}
                    </table>
                </h5>              
            </center>
